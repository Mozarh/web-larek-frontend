...
4. Класс Product - Представляет товар в интернет-магазине. Содержит всю необходимую информацию о товаре, такую как описание, цену и изображение. Этот класс используется для работы с API товаров и отображения их на странице.
